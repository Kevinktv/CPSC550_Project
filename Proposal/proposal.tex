...
We plan to do a comparative review and benchmark of more recent unlearning algorithms for image classification. We will use ResNet-18 as a baseline model, retrain from scratch to get an exact unlearning baseline, and evaluate the same metrics used for the Kaggle competition (\cite{neurips-2023-machine-unlearning}).

The algorithm we plan to compare are:
\begin{itemize}
