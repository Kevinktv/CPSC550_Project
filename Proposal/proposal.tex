...
The main contribution of this project will be a clear and reproducible benchmark of recent machine unlearning algorithms under a common experimental setup.
\printbibliography
\end{document}
