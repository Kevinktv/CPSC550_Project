...
\begin{abstract}
    ...
    We evaluate four unlearning methods: Masked-Small-Gradients (MSG), SCRUB, DELETE, and the 2023 Kaggle 2nd place winner. \textcolor{red}{todo: clean abstract later}
\end{abstract}
