...
This project aims to benchmark several recent approximate machine unlearning algorithms against a retraining baseline. We focus on image classification tasks, and evaluate the following unlearning algorithms: 
